...
// export default ProfilePage;
  ...
  //   {/* Toggle Button placed inside wrapperRef & click propagation stopped */}
  //   <div
  //     className="position-fixed"
  //     style={{
  //       top: "20px",
  ...
  //     }}
  //     onClick={(e) => {
  //       e.stopPropagation(); // ✅ Prevent closing when toggling
  //       toggleSidebar();
  //     }}
  //   >
  //     <span style={{ fontSize: "20px", color: "#000" }}>
    ...
    <div className="d-flex">
      {!isExamPage && (
        <>
          ...
          {/* Floating FaBars toggle button for ALL ROLES */}
          <div
            className="position-fixed"
            style={{
              top: "20px",
      ...
      <div
        className="container py-5"
        style={{
          marginLeft: !isExamPage ? (sidebarOpen ? "250px" : "0px") : "0px",
          transition: "margin-left 0.3s ease",
        }}
      >
        <div className="card shadow">
