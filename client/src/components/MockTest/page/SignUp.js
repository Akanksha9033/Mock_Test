...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) return setError(data?.message || "Signup failed. Try again.");
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              required
            />
            <div className="form-text text-muted">Must be a valid email like <code>example@gmail.com</code></div>
            {emailValid === false && (
