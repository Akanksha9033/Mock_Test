  ...
  const fetchUserResults = async () => {
    ...
    try {
      const res = await fetch(
        `${REACT_APP_API_URL}/api/name/search?name=${encodeURIComponent(
          searchUserId
        )}`
      );
      if (!res.ok) throw new Error("Failed to fetch results");
  ...
  return (
    <div className="d-flex flex-column flex-md-row min-vh-100">
      ...
      <div
        ...
        style={{ marginLeft: isCollapsed ? "0" : "250px", transition: "margin 0.3s ease" }}
      >
        <h1 className="mb-4 mt-4 mt-md-0 text-center" style={{ color: "#4748ac" }}>
          Welcome to Your Dashboard, {user?.name || "Teacher"}!
        </h1>
        <p className="mb-5 text-center" style={{ fontSize: "18px", color: "#555" }}>
          Manage your classes, track student progress, and schedule online sessions here.
        </p>
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          ...
          <div className="col">
            <div className="card shadow-sm border-light rounded">
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#4748ac" }}>Create Mock Tests</h5>
                <p className="card-text text-muted">Design and publish your mock tests.</p>
                <button className="btn btn-primary w-100" onClick={() => navigate("/create-mock-test")}>
                  Create Test
                </button>
              </div>
            </div>
          ...
          <div className="col">
            <div className="card shadow-sm border-light rounded">
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#4748ac" }}>Schedule Zoom Meeting</h5>
                <p className="card-text text-muted">Conduct live classes via Zoom.</p>
                <button className="btn btn-success w-100" onClick={openZoomMeeting}>
                  Start Zoom Meeting
                </button>
              </div>
            </div>
          ...
          <div className="col">
            <div className="card shadow-sm border-light rounded">
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#4748ac" }}>Upload Study Material</h5>
                <p className="card-text text-muted">Upload PDFs, notes, or slides.</p>
            ...
            <div className="card shadow-sm border-light rounded">
              <div className="card-body">
                ...
                <input
                  ...
                  onChange={(e) => setSearchUserId(e.target.value)}
                />
                <button className="btn btn-warning w-100" onClick={fetchUserResults}>
                  Fetch Report
                </button>
              </div>
            </div>
        ...
        {showModal && (
          <div className="modal fade show d-block" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title text-primary">Upload Study Material</h5>
        ...
        {showResultModal && (
          <div className="modal fade show d-block" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
            <div className="modal-dialog modal-lg">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title text-primary">Student Test Reports</h5>
                  <button className="btn-close" onClick={() => setShowResultModal(false)}></button>
                </div>
                <div className="modal-body" style={{ maxHeight: "400px", overflowY: "auto" }}>
                  {userResults.length === 0 ? (
                    <p>No reports found for this user.</p>
